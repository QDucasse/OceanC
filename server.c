...
void function_matcher(char* str){
	if (strstr(string,"modify speed") == 0){
		
	} 
	else if (strstr(string,"modify speed") == 0){
...
int main(int argc, char *argv[]) {
	...
	while(1){
		...
		//Dans le processus parent, gérer les déplacements toutes les X secondes	
	} //while(1)
} //main()
